...
public class TranslationsManager : MonoBehaviour
{
    ...
    private List<TranslationText> translationTexts = new();
    ...
    public void SetLanguage(int index)
    {
        ...
        foreach (TranslationText tt in translationTexts)
        {
            tt.RefreshLanguage(this);
        }
    }

    public void AddTextReference(TranslationText translationText) => translationTexts.Add(translationText);
}
